...
export const ANSWER_TYPE_HINTS: Record<AnswerType, string> = {
  ...
  fraction:                         'Enter as fraction (3/4) or mixed number (2 3/4)',
  ...
  MC:                               '',
  multiple_choice:                  '',
  decimal_or_fraction:              'Enter as decimal (0.75) or fraction (3/4) or mixed number (2 3/4)',
  ...
  decimal_or_fraction_or_percent:   'Enter as decimal (0.75), fraction (3/4), or percent (75%)',
