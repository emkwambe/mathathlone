...
export default async function AdminDashboard() {
  ...
  if (!profile) {
    return <MissingProfile email={user.email} role="school_admin" />;
  }
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600 max-w-xl mx-auto">
            Manage teachers, view school-wide analytics, oversee Heats, and approve regional advancement attestations. Detailed admin tooling is being built — check back soon.
          </p>
        </div>
      </main>
    </div>
